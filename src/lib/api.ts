    ...
    custom_fields: [
      {
        ...
        answer: "", // added extra field to insert the form answer
        type: "longtext",
        is_required: true,
      },
      {
...
export async function getCampaignForm(
  campaignId: string
): Promise<InfluencerCampaignForm> {
  return apiRequest<InfluencerCampaignForm>(
    APIMethod.GET,
    `/influencer/campaign/${campaignId}/form`
  );
}
